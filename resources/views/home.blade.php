        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                            ...
                            @foreach($testimonials as $testimonial)
                                <div class="bg-white p-6 rounded-xl shadow-sm border border-[#dbd3c8] hover:shadow-md transition-all">
                                    <div class="flex items-start mb-4">
                                        <!-- Profile Photo -->
                                       <img src="{{ $testimonial->profile_photo ? asset('storage/' . $testimonial->profile_photo) : 'https://img.icons8.com/?size=100&id=ABBSjQJK83zf&format=png&color=dbd3c8' }}"
                ...
                <section class="py-20 bg-[#ede6dd]">
                    <div class="container mx-auto px-4">
                        <div class="text-center mb-16">
                            <h2 class="text-4xl font-bold text-[#374151] mb-4">Memory Stats</h2>
                            <p class="text-xl text-[#374151]/90">Journey insights and memory numbers</p>
                        </div>
                        ...
                        <div class="grid md:grid-cols-3 gap-8 text-center">
                            ...
                            <div class="bg-white p-8 rounded-xl shadow-sm border border-[#dbd3c8]">
                                <div class="text-5xl font-bold text-[#374151] mb-2">{{ $stats['countries'] ?? 'N/A' }}</div>
